...
#### Track students and the courses they take, 1.4.2021

#### By Ben McFarland, Patrick Osten

## Description

This program will track all students and courses added. And track which students are enrolled in which courses.
...
- Once you have Git installed on your computer, go to this (GitHub repository)[https://github.com/harzulu/UniversityRegistrar], click the "Fork" button in the upper right hand corner of the page, and clone this application with the following command:`git clone https://github.com/harzulu/UniversityRegistrar`.
